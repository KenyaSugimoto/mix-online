...
## M5-29: テーブル画面の情報整理（アクション履歴/アクションボタン）

### 目的
アクション履歴と操作UIの見やすさを改善し、プレイ中の視線移動と操作ミスを減らす。

### 背景
アクション履歴（履歴）とアクションボタン配置に改善余地がある。

### 実装方針
- アクション履歴の表示量・優先度・配置を再設計する。
- アクションボタンの位置を「現在手番で最短操作できる」配置へ調整する。
- モバイル/デスクトップ双方で、ログと操作UIの干渉を防ぐ。

### 完了条件
- [ ] アクション履歴は重要情報が先に読める並び/見せ方になっている。
