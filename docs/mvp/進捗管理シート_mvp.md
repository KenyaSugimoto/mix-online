...
| M3 | Realtime + Game Engine成立 | IN_PROGRESS | 18% | Codex | 2026-02-11 | M3-01〜M3-02完了、M3-03着手 |
...
| --- | --- | --- | --- | --- | --- |
| M3-03 | 席管理コマンド（join/sitOut/return/leave）と状態遷移実装 | P0 | IN_PROGRESS | `SEATED_WAIT_NEXT_HAND`/`LEAVE_PENDING` を含む遷移整合 | [`状態遷移図_mvp.md`](./状態遷移図_mvp.md), [`画面設計書_mvp.md`](./画面設計書_mvp.md) |

## Next

| ID | Task | Priority | Status | Ready条件 | Link |
| --- | --- | --- | --- | --- | --- |
| M3-04 | ハンド開始〜3rd配札基盤（DealInit/PostAnte/DealCards3rd/BringIn） | P0 | NOT_STARTED | M3-03 完了 | [`詳細設計書_mvp.md`](./詳細設計書_mvp.md), [`E2Eシナリオ集_mvp.md`](./E2Eシナリオ集_mvp.md) |
...
| --- | --- | --- | --- | --- |
| 2026-W07 | 初版ドキュメント整備、実装タスク分解（Next/Backlog拡張）、M0-01〜M0-04完了、M1-01〜M1-04完了、M2-01〜M2-06完了、M3-01〜M3-02完了 | M3-03（席管理コマンド） | 仕様未決事項（DEC-01）が残存 | M3-03（席管理コマンド）継続 |
