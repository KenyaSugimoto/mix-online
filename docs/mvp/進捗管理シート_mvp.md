...
| --- | --- | --- | --- | --- | --- | --- |
| M0 | 品質ゲート固定（lint/typecheck/test） | IN_PROGRESS | 75% | Codex | TBA | M0-01/M0-02/M0-04完了、M0-03を継続 |
...
| --- | --- | --- | --- | --- |
| 2026-W07 | 初版ドキュメント整備、実装タスク分解（Next/Backlog拡張）、M0-01/M0-02/M0-04完了 | M0-03（入力バリデーション/共通エラー応答基盤） | 仕様未決事項（DEC-01）が残存 | M0-03 継続 |
