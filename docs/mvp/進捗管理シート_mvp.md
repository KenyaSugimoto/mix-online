...
| M1 | DB/マイグレーション運用確立 | IN_PROGRESS | 25% | Codex | TBA | M1-01完了、M1-02以降へ移行 |
...
| --- | --- | --- | --- | --- |
| 2026-W07 | 初版ドキュメント整備、実装タスク分解（Next/Backlog拡張）、M0-01〜M0-04完了、M1-01完了 | - | 仕様未決事項（DEC-01）が残存 | M1-02 着手 |
